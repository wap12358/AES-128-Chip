...
HD_PWD='F:/OneDrive/Study/IC2/AES-128-with-an-Instruction-Set/verifyPlatform/vivado/vivado.runs/platform_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log platform_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source platform_rst_ps7_0_50M_0.tcl
